...
export const PrivacyPolicy = () => (
  <div className={styles.root}>
    ...
    <p>
      ...
      name, e-mail address, mailing address or phone number. You may, however, visit our site
      anonymously.
    </p>
    <p>
      Like most websites, we use cookies to enhance your experience, gather general visitor
    ...
    <ul>
      ...
      <li>
        ...
        send you information and updates pertaining to your order or request, in addition to
    ...
    <p>
      ...
      information when you submit a request, place an order or enter, submit, or access your
      personal information. These security measures include: password protected directories and
      databases to safeguard your information, SSL (Secure Sockets Layered) technology to ensure
      that your information is fully encrypted and sent across the Internet securely or PCI Scanning
    ...
    <p>
      Yes. Cookies are small files that a site or its service provider transfers to your computers
    ...
    <p>
      <strong>Illinois Online Privacy Protection Act Compliance</strong>
    </p>
    <p>
      Because we value your privacy we have taken the necessary precautions to be in compliance with
      the Illinois Online Privacy Protection Act. We therefore will not distribute your personal
    ...
    <p>
      We have taken the necessary steps to ensure that we are compliant with the CAN-SPAM Act of
      2003 by never sending out misleading information.
    </p>
    <p>
    ...
    <p>
      ...
      update the Privacy Policy modification date below. Policy changes will apply only to
      information collected after the date of the change.
    </p>
    <p>
      <strong>This policy was last modified on 04-13/2019</strong>
    </p>
    <p>
    ...
    <p>
      ...
      <a
        href="https://www.sphereinc.com/contact-it-company"
        target="_blank"
